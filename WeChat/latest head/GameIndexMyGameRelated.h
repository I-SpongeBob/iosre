...
@class GameIndexMyGameRelated_IndexMyGamePicTpl, GameIndexMyGameRelated_IndexMyGameTextTpl, GameIndexMyGameRelated_IndexMyGameVideoCenterTpl, GameIndexMyGameRelated_VideoRecom, NSString;
...
@property(retain, nonatomic) GameIndexMyGameRelated_VideoRecom *tplVideoRecom; // @dynamic tplVideoRecom;
