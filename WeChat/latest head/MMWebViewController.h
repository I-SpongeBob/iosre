...
@property(nonatomic) _Bool m_bHasFinishLoadOnce; // @synthesize m_bHasFinishLoadOnce=_bHasFinishLoadOnce;
@property(nonatomic) _Bool m_bIsRestrictAppstore; // @synthesize m_bIsRestrictAppstore;
