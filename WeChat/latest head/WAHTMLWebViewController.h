...
@class MMJSApiVerifyMgr, MMURLHandler, MMWebProgressBar, NSMutableDictionary, NSString, NSURLRequest, UIButton, UILabel, UILongPressGestureRecognizer, UIView<YYWebViewInterface>, WAWebViewController, WAWebViewPlugin_HTMLWeb, WCDeepLinkHandler, WebViewA8KeyLogicImpl, WebViewJSLogicImpl;
