...
@class NSMutableDictionary, NSString, WCADBodyWrap, WCADCanvasInfo, WCADChainStrengthenInfo, WCADCommentWrap, WCADPageWrap, WCADPoiInfo, WCADVideoWrap, WCAdCardInfo, WCAdDislikeInfo, WCAdFeedDisplayInfo, WCAdSelectInfo, WCAdWeAppInfo, WCMultiLanguageItem;
