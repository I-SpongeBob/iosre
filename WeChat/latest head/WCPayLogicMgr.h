...
@interface WCPayLogicMgr : MMService <MMTipsViewControllerDelegate, ILinkEventExt, MMWebViewDelegate, MMKernelExt, MMService, WCPayNetworkHelperDelegate, MMPackageDownloadMgrExt, IMsgExt, IAutoVerifySMSExt, IClearDataMgrExt>
{
